...
public class DialogueManager : MonoBehaviour
{
    ...
    [SerializeField] private int dialogueSoundFrequency = 4;
    ...
    public bool dialogueLocked { get; private set; }
    ...
    private IEnumerator DisplayLine(string line)
    {
        ...
        foreach (char letter in line.ToCharArray())
        {
            ...
            else
            {
                ...
                // Play dialogue sound every N letters
                if (letterCount % dialogueSoundFrequency == 0 && dialogueSounds != null && dialogueSounds.Length > 0)
                {
        ...
        // Stop dialogue sound when typing finishes
    ...
    // Called by puzzle scripts when puzzle is completed
    public void UnlockDialogue()
    {
        ...
        if (postPuzzleInkJSON != null)
        {
            ...
            currentStory.ChoosePathString("siren_after_puzzle");
